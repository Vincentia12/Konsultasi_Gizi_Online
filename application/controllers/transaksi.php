...
class transaksi extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('transaksi/riwayat.php', $data);
		$this->load->view('footer/footer.php');
	}

    public function detailriwayattransaksi($id, $transaction_id)
    {
        $data['dataTransaksi'] = $this->modeldatapengguna->printDataTransaksi($id)->result();
        $data['dataKonsultasi'] = $this->modelkonsultasi->getDetailKonsultasi($id, $transaction_id)->result();
        $this->load->view('header/header.php');
        $this->load->view('transaksi/detailriwayat.php', $data);
        $this->load->view('footer/footer.php');
    }	
