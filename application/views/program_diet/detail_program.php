...
<body>
    ...
    <div class="banner_cos">
        <div class="jarak"></div>
        <h2 class="text-white text-center">Program Diet</h2>
                    ...
                    ?>
                            ...
                            <div class="col-2">
                                <div style="color: black">
                                    <h5>Nama Program : </h5>
                                    <h5>Harga Program : </h5>
                                    <h5>Rating Program : </h5>
                                    <h5>Program Diorder : </h5>
                                </div>
                            </div>
                            <div class="col-2">
                                <ul class="img-list5">
                                    <li>
                                        <div style="color: black">
                                            <h5 name="inputBookName2" id="inputBookName2" style="margin-left: 0px;"><?php echo $data->nama_program ?></h5>
