            ...
            <div class="container">
                <div class="row">
                    <?php foreach ($programdiet as $data) : ?>
                     ...
                     <a href="<?php echo site_url(); ?>katering/detail/<?php echo $data->id_program_diet_list ?>">
                        <img class="img-fluid" src="<?php echo $data->foto ?>" alt="gambar alam"
                           style="border-radius: 15px;">
                        <h4 style="margin-left: 15px;"><?php echo $data->nama_program ?></h4>
                        <div class="jarak"></div>
                     </a>
                  </div> -->
                        <div class="col-md-6">
                            <div class="card-deck">
                                <a href="<?php echo site_url(); ?>programdiet/detail/<?php echo $data->id_program_diet_list ?>">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo $data->foto ?>" alt="Card image cap" style="height: 400px; object-fit: cover;">
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo $data->nama_program ?></h5>
