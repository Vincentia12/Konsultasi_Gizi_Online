    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url() ?>dataDokter/updatedata" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="level" name="level" autocomplete="off" value="<?= $data->id_level ?>"></input>
                    </div>
