                                ...
                                <div class="carousel-item active">
                                    <div class="post-video">
                                        <div class="fluid-width-video-wrapper">
                                            <iframe width="1200" height="500" src="https://www.youtube.com/embed/dA8Smj5tZOQ"></iframe>
        ...
        <div class="container pt-5">
            <div style="height: 250px;" class="row bg-white">
                <div class="col-lg-3 col-md-3 col-sm-6  pl-0 pr-0">
                    <div style="height: 250px;" class="feature-box-item ">
                        <figure>
                            <img src="assets/image/calculator.svg" width="48px" alt="feature-box-icon" class="img-fluid">
                        </figure>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 pl-0 pr-0">
                    <div style="height: 250px;" class="feature-box-item ">
                        <figure>
                            <img src="assets/image/chat-right-dots.svg" alt="feature-box-icon" width="48px" class="img-fluid">
                        </figure>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 pl-0 pr-0">
                    <div style="height: 250px;" class="feature-box-item ">
                        <figure>
                            <img src="assets/image/konversi nilai.svg" alt="feature-box-icon" width="48px" class="img-fluid">
                        </figure>
            ...
            <div style="height: 250px;" class="row bg-white">
                <div class="col-lg-4 col-md-4 col-sm-6 pl-0 pr-0 border-bottom-0">
                    <div style="height: 250px;" class="feature-box-item">
                        <figure>
                            <img src="assets/image/katering diet.svg" alt="feature-box-icon" width="48px" class="img-fluid">
                        </figure>
                        <h5>Katering Diet</h5>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 pl-0 pr-0 border-bottom-0">
                    <div style="height: 250px;" class="feature-box-item">
                        <figure>
                            <img src="assets/image/program diet.svg" alt="feature-box-icon" width="48px" class="img-fluid">
                        </figure>
                        <h5>Program Diet</h5>
                    </div>
                </div>
