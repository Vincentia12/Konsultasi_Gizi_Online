								...
								<tbody>
									<?php foreach ($data as $data) : ?>
										<tr>
											...
											<td>
												<center><img src="<?= base_url() ?>assets/picture/<?= $data->foto ?>" alt="foto">
												</center>
											</td>
											<td>
												<a href="" class="btn btn-sm btn-info" role="button" data-toggle="modal" data-target="#editData"><i class="fa fa-edit"></i></a>
												<a href="<?= base_url() ?>konversiAdmin/deletedata/<?= $data->id_konversi_gizi ?>/<?= $data->foto ?>" class="btn btn-sm btn-danger" role="button"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?= base_url() ?>konversiAdmin/insertdata" method="post" enctype="multipart/form-data">
