<head>
	...
	<script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-Q6Gz6NV2VIcicDWO"></script>
...
<body>
	<section>
		...
		<div class="banner_cos">
			<div class="jarak"></div>
			<h2 class="text-white text-center">Formulir Konsultasi</h2>
							...
							<div class="justify-content-center">
								...
								<div class="banner banner_box_cos text-dark" style="border-radius: 5px 5px 5px 5px">
									...
									<form id="payment-form" method="post" action="">
										...
										<input type="datetime-local" class="input" id="tanggal_konsultasi" name="tanggal_konsultasi" placeholder="Tanggal Lahir" value="<?php echo $this->input->post('tanggal_konsultasi', TRUE); ?>" readonly>
										<br>
            ...
            <div class="container">
                <div class="row  justify-content-center">
                    <div class="col-md-12">
                        <div class="card-deck text-dark form-control">
                            <form action="" method="post" id="form_transaksi">
                                ...
                                <div class="input-field col s12">
                                    <select name="id_platform" id="id_platform" class="input validate" >
                                        <option value="">Pilih</option>
                                        <option value="1">Chatting via WhatsApp</option>
                                        <option value="2">Video Call via WhatsApp</option>
                                    </select>
                                    <label>Platform Konsultasi</label>
                                    <span class="error error_id_platform"></span>
                                </div>
                                <div class="input-field col s12">
                                    <select name="daftarkan" id="daftarkan" class="input validate" >
                                        <option value="">Pilih</option>
                                        <option value="ya">Iya</option>
                                        <option value="tidak">Tidak</option>
                                    </select>
                                    <label>Daftarkan orang lain?</label>
                                    <span class="error error_daftarkan"></span>
                                </div>
                                <div class="form_daftarkan" style="display: none;">
                                    <div class="input-field col s12">
                                        ...
                                        <ul class="collapsible">
                                            <li>
                                                ...
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="berat_badan">1. Berat badan ? (Kg) <span style="color: red;">*)</span></label>
                                                            <input placeholder="Berat badan ? (Kg)"  id="berat_badan" value="" type="number" name="berat_badan" class="input validate ">
                                                            <span class="error error_berat_badan"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="tinggi_badan">2. Tinggi badan ? (cm) <span style="color: red;">*)</span></label>
                                                            <input placeholder="Tinggi badan ? (cm)"  id="tinggi_badan" value="" type="number" name="tinggi_badan" class="input validate hitungimt">
                                                            <span class="error error_tinggi_badan"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="imt">3. Indeks Massa Tubuh (IMT) {Otomatis} <span style="color: red;">*)</span></label>
                                                            <input placeholder="Indeks Massa Tubuh (IMT) {Otomatis}"  readonly id="imt" value="" type="number" name="imt" class="input validate ">
                                                            <span class="error error_imt"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="kreatin_serum">5. Kreatin Serum </label>
                                                            <input placeholder="Kreatin Serum" id="kreatin_serum" value="" type="text" name="kreatin_serum" class="input validate ">
                                                            <span class="error error_kreatin_serum"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="albumin">8. Albumin </label>
                                                            <input placeholder="Albumin" id="albumin" value="" type="text" name="albumin" class="input validate ">
                                                            <span class="error error_albumin"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="lain_lain">10. Lain-Lain </label>
                                                            <input placeholder="Lain-Lain" id="lain_lain" value="" type="text" name="lain_lain" class="input validate ">
                                                            <span class="error error_lain_lain"></span>
                                                        </div>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="collapsible">Clinical History / Fisik Klinik (6)</div>
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="tensi_darah">11. Tensi darah (mmHg) </label>
                                                            <input placeholder="Tensi darah (mmHg)" id="tensi_darah" value="" type="text" name="tensi_darah" class="input validate ">
                                                            <span class="error error_tensi_darah"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="oedema">12. OEDEMA / Bengkak <span style="color: red;">*)</span></label>
                                                            <select name="oedema" id="oedema" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="keadaan_umum">13. Keadaan umum <span style="color: red;">*)</span></label>
                                                            <select name="keadaan_umum" id="keadaan_umum" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="sehat">Sehat</option>
                                                                <option value="lemah">Lemah</option>
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="mual">14. Mual <span style="color: red;">*)</span></label>
                                                            <select name="mual" id="mual" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="muntah">15. Muntah <span style="color: red;">*)</span></label>
                                                            <select name="muntah" id="muntah" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                            </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="diare">16. Diare <span style="color: red;">*)</span></label>
                                                            <select name="diare" id="diare" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                            </select>
                                            ...
                                            <li>
                                                <div class="collapsible">Dietary History / Riwayat Makan (5)</div>
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="nafsu_makan">17. Nafsu makan <span style="color: red;">*)</span></label>
                                                            <select name="nafsu_makan" id="nafsu_makan" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="baik">Baik</option>
                                                                <option value="turun">Turun</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="kesulitan_mengunyah">18. Kesulitan mengunyah <span style="color: red;">*)</span></label>
                                                            <select name="kesulitan_mengunyah" id="kesulitan_mengunyah" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="alergi_makan">19. Alergi makan <span style="color: red;">*)</span></label>
                                                            <select name="alergi_makan" id="alergi_makan" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="jika_alergi">20. Jika Anda memiliki alergi </label>
                                                            <input placeholder="Jika Anda memiliki alergi" id="jika_alergi" value="" type="text" name="jika_alergi" class="input validate ">
                                                            <span class="error error_jika_alergi"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="pola_makan_sehari">21. Pola makan sehari berapa kali <span style="color: red;">*)</span></label>
                                                            <select name="pola_makan_sehari" id="pola_makan_sehari" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="1x sehari">1x Sehari</option>
                                                                <option value="2x sehari">2x Sehari</option>
                                            ...
                                            <li>
                                                <div class="collapsible">Personal History / Riwayat Personal (9)</div>
                                                <div class="content">
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="pekerjaan">22. Pekerjaan <span style="color: red;">*)</span></label>
                                                            <select name="pekerjaan" id="pekerjaan" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="pns">Pns</option>
                                                                <option value="swasta">Swasta</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="pendidikan">24. Pendidikan <span style="color: red;">*)</span></label>
                                                            <select name="pendidikan" id="pendidikan" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="sd">Sd</option>
                                                                <option value="smp">Smp</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="merokok">25. Merokok ? <span style="color: red;">*)</span></label>
                                                            <select name="merokok" id="merokok" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="riwayat_sakit_keluarga">26. Riwayat sakit keluarga ? </label>
                                                            <input placeholder="Riwayat sakit keluarga ?" id="riwayat_sakit_keluarga" value="" type="text" name="riwayat_sakit_keluarga" class="input validate ">
                                                            <span class="error error_riwayat_sakit_keluarga"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="riwayat_sakit_dahulu">27. Riwayat sakit dahulu ? </label>
                                                            <input placeholder="Riwayat sakit dahulu ?" id="riwayat_sakit_dahulu" value="" type="text" name="riwayat_sakit_dahulu" class="input validate ">
                                                            <span class="error error_riwayat_sakit_dahulu"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="konsumsi_obat">28. Konsumsi obat ? <span style="color: red;">*)</span></label>
                                                            <select name="konsumsi_obat" id="konsumsi_obat" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="obat_apa">29. Obat apa ? </label>
                                                            <input placeholder="Obat apa ?" id="obat_apa" value="" type="text" name="obat_apa" class="input validate ">
                                                            <span class="error error_obat_apa"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="input-field col s12">
                                                            <label class="active" for="olahraga">30. Olahraga ? <span style="color: red;">*)</span></label>
                                                            <select name="olahraga" id="olahraga" class="input validate" >
                                                                <option value="">Pilih</option>
                                                                <option value="ya">Ya</option>
                                                                <option value="tidak">Tidak</option>
			...
			<script>
				...
				function validate() {
					$('#tinggi_badan').val() > 1 && $('#berat_badan').val() > 1 ? hitung() : $('#imt').val('');
				}
				...
				$(document).ready(function() {
					...
					$('#tinggi_badan, #berat_badan').change(function() {
						...
						var change = true,
							tinggiSaatIni = $('#tinggi_badan').val(),
							beratSaatIni = $('#berat_badan').val();

						if (
							($(this).attr('id') == 'tinggi_badan' && tinggiSaatIni == tinggi) ||
							($(this).attr('id') == 'berat_badan' && beratSaatIni == berat)
						) {
							change = false;
						}
