...
<body>
    ...
    <div class="row mb-3 pt-6 col-6 mx-auto justify-content-center">
        <button onclick="location.href = '<?php echo base_url() ?>riwayattransaksi/<?php echo $this->session->userdata('id')?>';" class="btn btn-login hover rounded-pill" name="login">Kembali</button>
    </div>
</body>
</div>
</div>
